...
class VideoConverterApp:
    ...
    def create_widgets(self):
        ...
        self.play_pause_button = tk.Button(self.master, textvariable=self.play_pause_button_text, command=self.toggle_play_pause)
        ...
        # Other options
        actions = ["Options", "Compare Videos", "Return motion vectors", "Convert to B&W", "convert to MP2", "Change Chroma SubSamp."]
        ...
        self.select_video_button.pack(side=tk.LEFT, anchor=tk.NW, padx=10, pady=10) #to position the widgets
    ...
    def select_video(self):
        ...
        if file_path:
            ...
            # Set window size based on video size
            self.master.geometry(f"{848}x{480}")
    ...
    def select_option(self):
        ...
        if option == "Return motion vectors":
            ...
            change_chroma_subsampling(input_video_path, "new_ChromaSS_"+input_video_path)
